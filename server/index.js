...
const PrivateKey = 'asdfe45we45w345wegw345werjktjwertkj';
...
mongoose.connect('mongodb+srv://lokesh:lokeshcz@cluster0.dsoakmx.mongodb.net/?retryWrites=true&w=majority');
...
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        const note = await new UserModel({
